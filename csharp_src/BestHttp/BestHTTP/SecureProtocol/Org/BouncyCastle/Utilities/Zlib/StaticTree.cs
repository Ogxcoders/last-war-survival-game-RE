...
internal sealed class StaticTree
{
	...
	internal static readonly StaticTree static_l_desc = new StaticTree(static_ltree, ZTree.extra_lbits, 257, 286, 15);

	internal static readonly StaticTree static_d_desc = new StaticTree(static_dtree, ZTree.extra_dbits, 0, 30, 15);

	internal static readonly StaticTree static_bl_desc = new StaticTree(null, ZTree.extra_blbits, 0, 19, 7);
