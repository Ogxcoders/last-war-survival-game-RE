...
public class SignerInformation
{
	...
	public BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.AttributeTable SignedAttributes
	{
		get
		{
			...
			{
				signedAttributeTable = new BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.AttributeTable(signedAttributeSet);
			}
	...
	public BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.AttributeTable UnsignedAttributes
	{
		get
		{
			...
			{
				unsignedAttributeTable = new BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.AttributeTable(unsignedAttributeSet);
			}
	...
	{
		BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.AttributeTable unsignedAttributes = UnsignedAttributes;
		if (unsignedAttributes == null)
		{
			return new SignerInformationStore(Platform.CreateArrayList(0));
		}
		IList list = Platform.CreateArrayList();
		foreach (BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.Attribute item in unsignedAttributes.GetAll(CmsAttributes.CounterSignature))
		{
			...
			{
				BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.SignerInfo instance = BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.SignerInfo.GetInstance(item2.ToAsn1Object());
	...
	private bool DoVerify(AsymmetricKeyParameter key)
	{
		...
		BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.AttributeTable signedAttributes = SignedAttributes;
	...
	{
		BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.Time signingTime = GetSigningTime();
		if (signingTime != null)
		{
	...
	private BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.Time GetSigningTime()
	{
		...
		try
		{
			return BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.Time.GetInstance(singleValuedSignedAttribute);
		}
	...
	public static SignerInformation AddCounterSigners(SignerInformation signerInformation, SignerInformationStore counterSigners)
	{
		...
		asn1EncodableVector.Add(new BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cms.Attribute(CmsAttributes.CounterSignature, new DerSet(asn1EncodableVector2)));
