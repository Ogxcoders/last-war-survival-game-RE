...
public class CmsCompressedDataStreamGenerator
{
	...
	public Stream Open(Stream outStream, string contentOID, string compressionOID)
	{
		...
		return new CmsCompressedOutputStream(new ZOutputStream(CmsUtilities.CreateBerOctetOutputStream(berSequenceGenerator3.GetRawOutputStream(), 0, isExplicit: true, _bufferSize), -1), berSequenceGenerator, berSequenceGenerator2, berSequenceGenerator3);
	}
}
