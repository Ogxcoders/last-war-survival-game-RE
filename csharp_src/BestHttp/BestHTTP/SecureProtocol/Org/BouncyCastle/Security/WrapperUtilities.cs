...
public sealed class WrapperUtilities
{
	...
	static WrapperUtilities()
	{
		...
		((WrapAlgorithm)(object)Enums.GetArbitraryValue(typeof(WrapAlgorithm))/*cast due to .constrained prefix*/).ToString();
	...
	public static IWrapper GetWrapper(string algorithm)
	{
		...
		try
		{
			switch ((WrapAlgorithm)(object)Enums.GetEnumValue(typeof(WrapAlgorithm), text2))
			{
