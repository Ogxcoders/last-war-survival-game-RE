	...
	private class UbiTweak
	{
		...
		public bool First
		{
			...
			set
			{
				if (value)
				{
					tweak[1] |= 4611686018427387904uL;
				}
				else
				{
					tweak[1] &= 13835058055282163711uL;
				}
			}
		}
		...
		public bool Final
		{
			...
			set
			{
				if (value)
				{
					tweak[1] |= 9223372036854775808uL;
				}
				else
				{
					tweak[1] &= 9223372036854775807uL;
				}
			}
		}
		...
		{
			return Type + " first: " + First.ToString() + ", final: " + Final.ToString();
		}
	}
