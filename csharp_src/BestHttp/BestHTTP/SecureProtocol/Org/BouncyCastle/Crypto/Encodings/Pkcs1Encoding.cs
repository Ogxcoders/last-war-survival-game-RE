...
public class Pkcs1Encoding : IAsymmetricBlockCipher
{
	...
	private byte[] DecodeBlock(byte[] input, int inOff, int inLen)
	{
		...
		Array.Copy(array2, num3, array3, 0, array3.Length);
		return array3;
	}
