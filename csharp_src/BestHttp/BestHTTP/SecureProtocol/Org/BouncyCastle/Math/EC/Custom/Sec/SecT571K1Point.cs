...
internal class SecT571K1Point : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		if (rawXCoord2.IsZero)
		{
			...
			{
				return new SecT571K1Point(curve, eCFieldElement10, curve.B, base.IsCompressed);
			}
		...
		return new SecT571K1Point(curve, eCFieldElement10, y, new ECFieldElement[1] { eCFieldElement11 }, base.IsCompressed);
	}
