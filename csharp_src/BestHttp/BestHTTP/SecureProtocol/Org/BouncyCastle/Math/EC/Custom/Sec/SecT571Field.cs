...
internal class SecT571Field
{
	...
	public static void Reduce5(ulong[] z, int zOff)
	{
		...
		z[zOff + 8] = num & 0x7FFFFFFFFFFFFFFL;
	}
	...
	protected static void ImplMultiply(ulong[] x, ulong[] y, ulong[] zz)
	{
		...
		for (int num4 = 56; num4 >= 0; num4 -= 8)
		{
			for (int i = 1; i < 9; i += 2)
			{
				int num5 = (int)(x[i] >> num4);
				uint num6 = (uint)num5 & num3;
				uint num7 = (uint)(num5 >>> 4) & num3;
		...
		for (int num8 = 56; num8 >= 0; num8 -= 8)
		{
			for (int j = 0; j < 9; j += 2)
			{
				int num9 = (int)(x[j] >> num8);
				uint num10 = (uint)num9 & num3;
				uint num11 = (uint)(num9 >>> 4) & num3;
