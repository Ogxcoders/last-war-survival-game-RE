...
internal class SecT571R1Point : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		if (rawXCoord2.IsZero)
		{
			...
			{
				return new SecT571R1Point(curve, eCFieldElement10, SecT571R1Curve.SecT571R1_B_SQRT, base.IsCompressed);
			}
		...
		return new SecT571R1Point(curve, eCFieldElement10, y, new ECFieldElement[1] { eCFieldElement11 }, base.IsCompressed);
	}
	...
	public override ECPoint Twice()
	{
		...
		return new SecT571R1Point(curve, eCFieldElement4, y, new ECFieldElement[1] { eCFieldElement5 }, base.IsCompressed);
	}
