...
public abstract class X25519Field
{
	...
	public static void Sqr(int[] x, int[] z)
	{
		...
		num47 >>= 25;
		num47 = num15 + (num47 + num43 - num20) * 38;
		z[0] = (int)num47 & 0x3FFFFFF;
		num47 >>= 26;
		num47 += num16 + (num44 - num21) * 38;
		z[1] = (int)num47 & 0x3FFFFFF;
		num47 >>= 26;
		num47 += num17 + (num45 - num22) * 38;
		z[2] = (int)num47 & 0x1FFFFFF;
		num47 >>= 25;
		num47 += num18 + (num46 - num23) * 38;
		z[3] = (int)num47 & 0x3FFFFFF;
		num47 >>= 26;
		num47 += num19 + num32 * 38;
