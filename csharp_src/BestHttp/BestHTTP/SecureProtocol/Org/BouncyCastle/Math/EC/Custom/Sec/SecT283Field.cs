...
internal class SecT283Field
{
	...
	protected static void ImplMultiply(ulong[] x, ulong[] y, ulong[] zz)
	{
		...
		ulong num26 = (zz[8] = num25 ^ array3[17]);
		ulong num27 = num25 ^ num19;
		ulong num28 = array3[15] ^ array3[16];
		ulong num29 = (zz[7] = num27 ^ num28) ^ num13;
		ulong num30 = array3[19] ^ array3[20];
		ulong num31 = array3[25] ^ array3[24];
		ulong num32 = array3[18] ^ array3[23];
		ulong num33 = num30 ^ num31;
		ulong num34 = num33 ^ num32 ^ num29;
		zz[4] = num34;
		ulong num35 = num17 ^ num26;
		ulong num36 = num33 ^ num35;
		ulong num37 = array3[21] ^ array3[22];
		ulong num38 = num36 ^ num37;
		zz[5] = num38;
		ulong num39 = num20 ^ array3[0] ^ array3[9] ^ num21 ^ array3[21] ^ array3[23] ^ array3[25];
		zz[6] = num39;
		ImplCompactExt(zz);
	}
