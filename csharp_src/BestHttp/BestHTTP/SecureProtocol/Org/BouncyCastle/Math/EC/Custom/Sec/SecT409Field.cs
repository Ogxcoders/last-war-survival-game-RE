...
internal class SecT409Field
{
	...
	public static void Sqrt(ulong[] x, ulong[] z)
	{
		...
		ulong num6 = (num5 & 0xFFFFFFFFu) | (num2 << 32);
		ulong num7 = (num5 >> 32) | (num2 & 0xFFFFFFFF00000000uL);
		ulong num8 = Interleave.Unshuffle(x[4]);
		num2 = Interleave.Unshuffle(x[5]);
		ulong num9 = (num8 & 0xFFFFFFFFu) | (num2 << 32);
		ulong num10 = (num8 >> 32) | (num2 & 0xFFFFFFFF00000000uL);
		ulong num11 = Interleave.Unshuffle(x[6]);
		ulong num12 = num11 & 0xFFFFFFFFu;
	...
	protected static void ImplMulwAcc(ulong[] xs, ulong y, ulong[] z, int zOff)
	{
		...
		for (int i = 0; i < 7; i++)
		{
			...
			while ((num5 -= 6) > 0);
			z[zOff + i] ^= num4 & 0x7FFFFFFFFFFFFFFL;
