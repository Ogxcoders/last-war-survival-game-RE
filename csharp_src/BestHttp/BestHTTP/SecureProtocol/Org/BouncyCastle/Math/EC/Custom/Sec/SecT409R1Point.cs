...
internal class SecT409R1Point : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		if (rawXCoord2.IsZero)
		{
			...
			{
				return new SecT409R1Point(curve, eCFieldElement10, curve.B.Sqrt(), base.IsCompressed);
			}
		...
		return new SecT409R1Point(curve, eCFieldElement10, y, new ECFieldElement[1] { eCFieldElement11 }, base.IsCompressed);
	}
	...
	public override ECPoint Twice()
	{
		...
		return new SecT409R1Point(curve, eCFieldElement4, y, new ECFieldElement[1] { eCFieldElement5 }, base.IsCompressed);
	}
	...
	public override ECPoint TwicePlus(ECPoint b)
	{
		...
		return new SecT409R1Point(curve, x2, y, new ECFieldElement[1] { eCFieldElement7 }, base.IsCompressed);
	}
	...
	public override ECPoint Negate()
	{
		...
		ECFieldElement rawYCoord = base.RawYCoord;
		ECFieldElement eCFieldElement = base.RawZCoords[0];
		return new SecT409R1Point(Curve, rawXCoord, rawYCoord.Add(eCFieldElement), new ECFieldElement[1] { eCFieldElement }, base.IsCompressed);
	}
}
