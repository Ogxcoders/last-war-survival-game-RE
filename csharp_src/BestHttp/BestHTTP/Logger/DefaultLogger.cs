...
public class DefaultLogger : ILogger
{
	...
	public DefaultLogger()
	{
		...
		Level = (Debug.isDebugBuild ? Loglevels.Warning : Loglevels.Error);
	}
	...
	public void Exception(string division, string msg, Exception ex)
	{
		...
		try
		{
			...
			Debug.LogError(string.Format(FormatEx, GetFormattedTime(), division, msg, empty, (ex != null) ? ex.StackTrace : "null"));
		}
		catch
		{
		}
