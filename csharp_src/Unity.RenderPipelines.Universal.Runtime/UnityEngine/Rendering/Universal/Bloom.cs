...
{
	[Tooltip("DownSample")]
	public ClampedIntParameter _downsample = new ClampedIntParameter(4, 3, 6);

	[Tooltip("Blur Iterations")]
	public ClampedIntParameter _blurIterations = new ClampedIntParameter(2, 0, 10);

	[Tooltip("Blur Size")]
	public ClampedFloatParameter _blursize = new ClampedFloatParameter(1f, 0f, 5f);
