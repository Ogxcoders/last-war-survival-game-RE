...
public class Lua
{
	...
	{
		public static Func<byte[]> GetStrBuff;

		public static Action<byte[]> SetStrBuff;
	...
	{
		public static Func<int> GetLUA_REGISTRYINDEX;

		internal static int LUA_REGISTRYINDEX => GetLUA_REGISTRYINDEX();
	}
