...
public static class Environment
{
	...
	public static Version Version => new Version("4.0.50524.0");
	...
	public static string ExpandEnvironmentVariables(string name)
	{
		...
		do
		{
			...
			string environmentVariable = GetEnvironmentVariable(text);
			int num3 = num2;
			...
			int count = ((num == -1 || num2 == -1) ? (length - num4 - 1) : ((environmentVariable == null) ? (num - num3) : (num - num4 - 1)));
			if (num >= num4 || num == -1)
			{
