...
internal static class DefaultPolicies
{
	...
	private const string DnsPermissionClass = "System.Net.DnsPermission, System, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e";

	private const string EventLogPermissionClass = "System.Diagnostics.EventLogPermission, System, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e";
	...
	private const string SocketPermissionClass = "System.Net.SocketPermission, System, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e";

	private const string WebPermissionClass = "System.Net.WebPermission, System, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e";

	private const string PerformanceCounterPermissionClass = "System.Diagnostics.PerformanceCounterPermission, System, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e";
	...
	public static StrongNameMembershipCondition FullTrustMembership(string name, Key key)
	{
		...
		if (_fxVersion == null)
		{
			_fxVersion = new Version("2.0.5.0");
		}
	...
	private static NamedPermissionSet BuildLocalIntranet()
	{
		...
		namedPermissionSet.AddPermission(PermissionBuilder.Create("System.Net.DnsPermission, System, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", PermissionState.Unrestricted));
	...
	private static NamedPermissionSet BuildEverything()
	{
		...
		namedPermissionSet.AddPermission(PermissionBuilder.Create("System.Diagnostics.EventLogPermission, System, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", PermissionState.Unrestricted));
		namedPermissionSet.AddPermission(PermissionBuilder.Create("System.Net.SocketPermission, System, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", PermissionState.Unrestricted));
		namedPermissionSet.AddPermission(PermissionBuilder.Create("System.Net.WebPermission, System, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", PermissionState.Unrestricted));
		namedPermissionSet.AddPermission(PermissionBuilder.Create("System.Diagnostics.PerformanceCounterPermission, System, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", PermissionState.Unrestricted));
