...
public class GraphyManager : G_Singleton<GraphyManager>
{
	...
	[SerializeField]
	private Color m_luaRamColor = new Color(1f, 0.51f, 0.33f);
	...
	private Func<int> m_GetLuaMemory;
	...
	public Color LuaRamColor
	{
		get
		{
			return m_luaRamColor;
		}
		set
		{
			m_luaRamColor = value;
	...
	public void SetLuaMemoryGetter(Func<int> luaMemoryGetter)
	{
		m_GetLuaMemory = luaMemoryGetter;
	}

	public int GetLuaMemory()
	{
		if (m_GetLuaMemory == null)
		{
			return 0;
		}
		return m_GetLuaMemory();
	}
