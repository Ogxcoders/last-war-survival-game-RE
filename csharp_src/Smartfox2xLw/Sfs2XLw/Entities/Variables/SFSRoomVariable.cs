...
public class SFSRoomVariable : BaseVariable, RoomVariable, Variable
{
	...
	{
		return new SFSRoomVariable(sfsa.GetUtfString(0), sfsa.GetElementAt(2), sfsa.GetByte(1))
		{
	...
	{
		return string.Concat("[RoomVar: ", name, ", type: ", type, ", value: ", val, ", private: ", isPrivate.ToString(), "]");
	}
}
