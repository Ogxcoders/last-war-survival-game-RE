...
public class SFSObject : ISFSObject
{
	...
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.NULL, null, -1);
	}

	public void PutBool(string key, bool val)
	{
		dataHolder[key] = new SFSPrimitiveDataWrapper<bool>(SFSDataType.BOOL, val, -1);
	}

	public void PutByte(string key, byte val)
	{
		dataHolder[key] = new SFSPrimitiveDataWrapper<byte>(SFSDataType.BYTE, val, -1);
	}

	public void PutShort(string key, short val)
	{
		dataHolder[key] = new SFSPrimitiveDataWrapper<short>(SFSDataType.SHORT, val, -1);
	}

	public void PutInt(string key, int val)
	{
		dataHolder[key] = new SFSPrimitiveDataWrapper<int>(SFSDataType.INT, val, -1);
	}

	public void PutLong(string key, long val)
	{
		dataHolder[key] = new SFSPrimitiveDataWrapper<long>(SFSDataType.LONG, val, -1);
	}

	public void PutFloat(string key, float val)
	{
		dataHolder[key] = new SFSPrimitiveDataWrapper<float>(SFSDataType.FLOAT, val, -1);
	}

	public void PutDouble(string key, double val)
	{
		dataHolder[key] = new SFSPrimitiveDataWrapper<double>(SFSDataType.DOUBLE, val, -1);
	}

	public void PutUtfString(string key, string val)
	{
		dataHolder[key] = new SFSStringDataWrapper(SFSDataType.UTF_STRING, val, -1, -1);
	}

	public void PutText(string key, string val)
	{
		dataHolder[key] = new SFSStringDataWrapper(SFSDataType.TEXT, val, -1, -1);
	}

	public void PutBoolArray(string key, bool[] val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.BOOL_ARRAY, val, -1);
	}

	public void PutByteArray(string key, ByteArray val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.BYTE_ARRAY, val, -1);
	}

	public void PutShortArray(string key, short[] val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.SHORT_ARRAY, val, -1);
	}

	public void PutIntArray(string key, int[] val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.INT_ARRAY, val, -1);
	}

	public void PutLongArray(string key, long[] val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.LONG_ARRAY, val, -1);
	}

	public void PutFloatArray(string key, float[] val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.FLOAT_ARRAY, val, -1);
	}

	public void PutDoubleArray(string key, double[] val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.DOUBLE_ARRAY, val, -1);
	}

	public void PutUtfStringArray(string key, string[] val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.UTF_STRING_ARRAY, val, -1);
	}

	public void PutSFSArray(string key, ISFSArray val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.SFS_ARRAY, val, -1);
	}

	public void PutSFSObject(string key, ISFSObject val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.SFS_OBJECT, val, -1);
	}

	public virtual void PutClass(string key, object val)
	{
		dataHolder[key] = new SFSRefDataWrapper(SFSDataType.CLASS, val, -1);
	}
