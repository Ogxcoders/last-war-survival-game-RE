...
namespace Sfs2XLw.Entities.Managers;
...
public class SFSBuddyManager : IBuddyManager
{
	...
	public string MyNickName
	{
		get
		{
			return GetMyVariable(ReservedBuddyVariables.BV_NICKNAME)?.GetStringValue();
		}
		set
		{
	...
	public string MyState
	{
		get
		{
			return GetMyVariable(ReservedBuddyVariables.BV_STATE)?.GetStringValue();
		}
		set
		{
