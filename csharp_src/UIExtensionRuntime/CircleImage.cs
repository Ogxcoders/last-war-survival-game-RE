...
public class CircleImage : BaseImage
{
	...
	protected override void OnPopulateMesh(VertexHelper vh)
	{
		...
		{
			GenerateSprite(vh, lPreserveAspect: true);
		}
	}
	...
	private void GenerateSprite(VertexHelper vh, bool lPreserveAspect)
	{
		if (!(base.sprite == null))
		{
			Vector2 vector = new Vector2(base.sprite.rect.width, base.sprite.rect.height);
			Vector2 vector2 = base.sprite.pivot / vector;
			...
			Vector3 size = base.sprite.bounds.size;
			Vector2 vector4 = (pivot - vector2) * vector3;
			Color color = this.color;
			vh.Clear();
			Vector2[] vertices = base.sprite.vertices;
			Vector2[] uv = base.sprite.uv;
			...
			ushort[] triangles = base.sprite.triangles;
