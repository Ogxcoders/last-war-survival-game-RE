...
public class UIParticleSystem : MaskableGraphic
{
	...
	protected override void OnPopulateMesh(VertexHelper vh)
	{
		...
		for (int i = 0; i < particles; i++)
		{
			...
			Vector2 vector = ((_particleSystem.simulationSpace == ParticleSystemSimulationSpace.Local) ? particle.position : _transform.InverseTransformPoint(particle.position));
