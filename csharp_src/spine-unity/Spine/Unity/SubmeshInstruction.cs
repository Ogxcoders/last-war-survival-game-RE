...
public struct SubmeshInstruction
{
	...
	{
		return string.Format("[SubmeshInstruction: slots {0} to {1}. (Material){2}. preActiveClippingSlotSource:{3}]", startSlot, endSlot - 1, (material == null) ? "<none>" : material.name, preActiveClippingSlotSource);
	}
}
