...
public class DOTweenAnimation : ABSAnimationComponent
{
	...
	public bool isAutoMirrorUIProcessedInArabic = true;
	...
	private void Awake()
	{
		if (isActive && isValid && (targetType != TargetType.RectTransform || GameEntryProxy.Localization == null || !GameEntryProxy.Localization.GetIsArabicAutoMirrorOpen() || !isAutoMirrorUIProcessedInArabic) && (animationType != AnimationType.Move || !useTargetAsV3))
		{
			CreateTween();
			_tweenCreated = true;
		}
	...
	{
		bool flag = Application.isPlaying && GameEntryProxy.Localization != null && GameEntryProxy.Localization.GetIsArabicAutoMirrorOpen() && isAutoMirrorUIProcessedInArabic;
