...
public class ContinuousHapticsDemoManager : DemoManager
{
	...
	protected Color _continuousButtonOnColor = new Color32(216, 85, 85, byte.MaxValue);

	protected Color _continuousButtonOffColor = new Color32(242, 27, 80, byte.MaxValue);
	...
	protected virtual void UpdateContinuousDemo()
	{
		...
		else
		{
			...
			{
				MMVibrationManager.StopContinuousHaptic(alsoRumble: true);
				OnHapticsStopped();
			}
		}
	...
	protected virtual void UpdateContinuous()
	{
		if (_continuousActive)
		{
			MMVibrationManager.UpdateContinuousHaptic(ContinuousIntensity, ContinuousSharpness, alsoRumble: true, -1, threaded: true);
	...
	public virtual void ContinuousHapticsButton()
	{
		if (!_continuousActive)
		{
			MMVibrationManager.ContinuousHaptic(ContinuousIntensity, ContinuousSharpness, ContinuousDuration, HapticTypes.LightImpact, this, alsoRumble: true, -1, threaded: true);
