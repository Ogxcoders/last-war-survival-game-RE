...
public class V2DemoManager : MonoBehaviour
{
	...
	protected virtual void Initialization()
	{
		...
		Pages[0].gameObject.SetActive(value: true);
		if (SoundActive)
		{
	...
	public virtual void PreviousPage()
	{
		...
		{
			CurrentPage--;
			Transition(CurrentPage + 1, CurrentPage, goingRight: false);
			SetCurrentPage();
		}
	}
	...
	public virtual void NextPage()
	{
		...
		{
			CurrentPage++;
			Transition(CurrentPage - 1, CurrentPage, goingRight: true);
			SetCurrentPage();
		}
	}
	...
	{
		MMVibrationManager.StopAllHaptics(alsoRumble: true);
	...
	protected virtual IEnumerator TransitionCoroutine(int previous, int next, bool goingRight)
	{
		...
		Pages[next].gameObject.SetActive(value: true);
		float timeSpent = 0f;
		...
		Pages[previous].gameObject.SetActive(value: false);
	}

	public virtual void TurnHapticsOn()
	{
		MMVibrationManager.SetHapticsActive(status: true);
	...
	public virtual void TurnHapticsOff()
	{
		...
		MMVibrationManager.SetHapticsActive(status: false);
	}
