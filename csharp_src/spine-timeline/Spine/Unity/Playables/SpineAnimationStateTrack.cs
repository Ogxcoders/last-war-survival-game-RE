...
public class SpineAnimationStateTrack : TrackAsset
{
	...
	public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
	{
		...
		{
			SpineAnimationStateClip spineAnimationStateClip = clip.asset as SpineAnimationStateClip;
			if (spineAnimationStateClip != null)
			{
				spineAnimationStateClip.timelineClip = clip;
			}
		}
