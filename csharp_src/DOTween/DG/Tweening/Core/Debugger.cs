...
public static class Debugger
{
	...
	{
		message = "<color=#0099bc><b>DOTWEEN ► </b></color>" + message;
	...
	public static void LogWarning(object message, Tween t = null)
	{
		...
		if (DOTween.debugMode && t != null)
		{
			...
			if (flag || flag2 || flag3)
			{
				...
				if (flag)
				{
					message = message?.ToString() + $"-[debug target ID: {t.debugTargetId}]-";
				}
				if (flag2)
				{
					message = message?.ToString() + $"-[stringId: {t.stringId}]-";
				}
				if (flag3)
				{
					message = message?.ToString() + $"-[intId: {t.intId}]-";
				}
			}
		}
