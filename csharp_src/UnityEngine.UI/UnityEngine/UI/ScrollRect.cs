...
public class ScrollRect : UIBehaviour, IInitializePotentialDragHandler, IEventSystemHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup, ILayoutController
{
	...
	private const float scrollSpeedRatio = 1f;
	...
	public bool InertiaSkipNormalizePosition { get; set; }
	...
	public virtual void OnScroll(PointerEventData data)
	{
		...
		anchoredPosition += scrollDelta * m_ScrollSensitivity * 1f;
	...
	public void OffsetPrevPosition(Vector2 anchoredPosition)
	{
		if (m_Dragging && m_Inertia)
		{
			Vector2 vector = m_Content.anchoredPosition - m_PrevPosition;
			m_PrevPosition = anchoredPosition - vector;
		}
	}
	...
	protected virtual void SetNormalizedPosition(float value, int axis)
	{
		EnsureLayoutHasRebuilt();
		UpdateBounds();
		if (!InertiaSkipNormalizePosition || !m_Inertia || !(Mathf.Abs(m_Velocity[axis]) > 0.01f))
		{
