...
internal sealed class HttpListenerPrefix
{
	...
	public static void CheckPrefix(string uriPrefix)
	{
		...
		if (num2 > 0)
		{
			...
			if (!int.TryParse(uriPrefix.Substring(num2 + 1, num3 - num2 - 1), out var result) || !result.IsPortNumber())
			{
				throw new ArgumentException("An invalid port is specified.");
			}
		}
		else if (uriPrefix.IndexOf('/', num, length - num) == -1)
		{
			throw new ArgumentException("No path is specified.");
		}
	...
	public override bool Equals(object obj)
	{
		...
		{
			return httpListenerPrefix._original == _original;
		}
		return false;
	}
