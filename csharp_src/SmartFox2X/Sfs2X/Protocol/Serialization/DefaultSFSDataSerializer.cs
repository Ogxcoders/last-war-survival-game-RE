...
public class DefaultSFSDataSerializer : ISFSDataSerializer
{
	...
	{
		return IBinary2Object(data);
	}

	public ISFSObject IBinary2Object(IByteArray data)
	{
		if (data.Length < 3)
		{
	...
	private ISFSObject DecodeSFSObject(IByteArray buffer)
	{
		...
		SFSObject sFSObject = SFSObject.NewInstance(num);
		try
		{
			for (int i = 0; i < num; i++)
			{
	...
	{
		return IBinary2Array(data);
	}

	public ISFSArray IBinary2Array(IByteArray data)
	{
		if (data.Length < 3)
		{
	...
	private ISFSArray DecodeSFSArray(IByteArray buffer)
	{
		SFSDataType sFSDataType = (SFSDataType)buffer.ReadByte();
		...
		ISFSArray iSFSArray = SFSArray.NewInstance(num);
		try
		{
			for (int i = 0; i < num; i++)
			{
	...
	private SFSDataWrapper DecodeObject(IByteArray buffer)
	{
		SFSDataType sFSDataType = (SFSDataType)buffer.ReadByte();
		switch (sFSDataType)
		{
		...
		case SFSDataType.SFS_ARRAY:
			buffer.Position--;
			return new SFSRefDataWrapper(17, DecodeSFSArray(buffer));
		case SFSDataType.SFS_OBJECT:
		{
			...
			return new SFSRefDataWrapper(type, data);
		}
		default:
	...
	private SFSDataWrapper BinDecode_NULL(IByteArray buffer)
	{
		return new SFSRefDataWrapper(SFSDataType.NULL, null);
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_BOOL(IByteArray buffer)
	{
		return new SFSPrimitiveDataWrapper<bool>(SFSDataType.BOOL, buffer.ReadBool());
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_BYTE(IByteArray buffer)
	{
		return new SFSPrimitiveDataWrapper<byte>(SFSDataType.BYTE, buffer.ReadByte());
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_SHORT(IByteArray buffer)
	{
		return new SFSPrimitiveDataWrapper<short>(SFSDataType.SHORT, buffer.ReadShort());
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_INT(IByteArray buffer)
	{
		return new SFSPrimitiveDataWrapper<int>(SFSDataType.INT, buffer.ReadInt());
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_LONG(IByteArray buffer)
	{
		return new SFSPrimitiveDataWrapper<long>(SFSDataType.LONG, buffer.ReadLong());
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_FLOAT(IByteArray buffer)
	{
		return new SFSPrimitiveDataWrapper<float>(SFSDataType.FLOAT, buffer.ReadFloat());
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_DOUBLE(IByteArray buffer)
	{
		return new SFSPrimitiveDataWrapper<double>(SFSDataType.DOUBLE, buffer.ReadDouble());
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_UTF_STRING(IByteArray buffer)
	{
		return new SFSRefDataWrapper(SFSDataType.UTF_STRING, buffer.ReadUTF());
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_TEXT(IByteArray buffer)
	{
		return new SFSRefDataWrapper(SFSDataType.UTF_STRING, buffer.ReadText());
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_BOOL_ARRAY(IByteArray buffer)
	{
		...
		return new SFSRefDataWrapper(SFSDataType.BOOL_ARRAY, array);
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_BYTE_ARRAY(IByteArray buffer)
	{
		...
		return new SFSRefDataWrapper(SFSDataType.BYTE_ARRAY, data);
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_SHORT_ARRAY(IByteArray buffer)
	{
		int typedArraySize = GetTypedArraySize(buffer);
		...
		return new SFSRefDataWrapper(SFSDataType.SHORT_ARRAY, array);
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_INT_ARRAY(IByteArray buffer)
	{
		int typedArraySize = GetTypedArraySize(buffer);
		...
		return new SFSRefDataWrapper(SFSDataType.INT_ARRAY, array);
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_LONG_ARRAY(IByteArray buffer)
	{
		int typedArraySize = GetTypedArraySize(buffer);
		...
		return new SFSRefDataWrapper(SFSDataType.LONG_ARRAY, array);
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_FLOAT_ARRAY(IByteArray buffer)
	{
		int typedArraySize = GetTypedArraySize(buffer);
		...
		return new SFSRefDataWrapper(SFSDataType.FLOAT_ARRAY, array);
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_DOUBLE_ARRAY(IByteArray buffer)
	{
		int typedArraySize = GetTypedArraySize(buffer);
		...
		return new SFSRefDataWrapper(SFSDataType.DOUBLE_ARRAY, array);
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SFSDataWrapper BinDecode_UTF_STRING_ARRAY(IByteArray buffer)
	{
		int typedArraySize = GetTypedArraySize(buffer);
		...
		return new SFSRefDataWrapper(SFSDataType.UTF_STRING_ARRAY, array);
	}

	private int GetTypedArraySize(IByteArray buffer)
	{
	...
	private SFSDataWrapper decodeJsonObject(JsonData jdo)
	{
		if (jdo == null)
		{
			return new SFSRefDataWrapper(SFSDataType.NULL, jdo);
		}
		if (jdo.IsInt)
		{
			return new SFSPrimitiveDataWrapper<int>(SFSDataType.INT, (int)jdo);
		}
		if (jdo.IsLong)
		{
			return new SFSPrimitiveDataWrapper<long>(SFSDataType.LONG, (long)jdo);
		}
		if (jdo.IsDouble)
		{
			return new SFSPrimitiveDataWrapper<double>(SFSDataType.DOUBLE, (double)jdo);
		}
		if (jdo.IsBoolean)
		{
			return new SFSPrimitiveDataWrapper<bool>(SFSDataType.BOOL, (bool)jdo);
		}
		if (jdo.IsString)
		{
			return new SFSRefDataWrapper(SFSDataType.UTF_STRING, (string)jdo);
		}
		if (jdo.IsObject)
		{
			if (jdo.Keys.Count == 0)
			...
			return new SFSRefDataWrapper(SFSDataType.SFS_OBJECT, decodeSFSObject(jdo));
		}
		if (jdo.IsArray)
		{
			return new SFSRefDataWrapper(SFSDataType.SFS_ARRAY, decodeSFSArray(jdo));
		}
	...
	private SFSDataWrapper WrapField(object val)
	{
		...
		if (val is bool)
		{
			result = new SFSPrimitiveDataWrapper<bool>(SFSDataType.BOOL, (bool)val);
		}
		else if (val is byte)
		{
			result = new SFSPrimitiveDataWrapper<byte>(SFSDataType.BYTE, (byte)val);
		}
		else if (val is short)
		{
			result = new SFSPrimitiveDataWrapper<short>(SFSDataType.SHORT, (short)val);
		}
		else if (val is int)
		{
			result = new SFSPrimitiveDataWrapper<int>(SFSDataType.INT, (int)val);
		}
		else if (val is long)
		{
			result = new SFSPrimitiveDataWrapper<long>(SFSDataType.LONG, (long)val);
		}
		else if (val is float)
		{
			result = new SFSPrimitiveDataWrapper<float>(SFSDataType.FLOAT, (float)val);
		}
		else if (val is double)
		{
			result = new SFSPrimitiveDataWrapper<double>(SFSDataType.DOUBLE, (double)val);
		}
		else if (val is string)
		{
			result = new SFSRefDataWrapper(SFSDataType.UTF_STRING, val);
		}
		else if (val is ArrayList)
		{
			result = new SFSRefDataWrapper(SFSDataType.SFS_ARRAY, UnrollArray(val as ArrayList));
		}
		else if (val is SerializableSFSType)
		{
			result = new SFSRefDataWrapper(SFSDataType.SFS_OBJECT, Cs2Sfs(val));
		}
		else if (val is Hashtable)
		{
			result = new SFSRefDataWrapper(SFSDataType.SFS_OBJECT, UnrollDictionary(val as Hashtable));
		}
		return result;
	}
