...
public class SmartFox : IDispatchable
{
	...
	private UseWebSocket? useWebSocket;
	...
	public bool UdpAvailable => socketClient.UdpManager != null;
	...
	public IEnumerator InitCrypto()
	{
		...
		return new CryptoInitializer(this).Run();
	}
	...
	{
		SFSEvent obj = e as SFSEvent;
		ConfigLoader configLoader = obj.Target as ConfigLoader;
		ConfigData configData = obj.Params["cfg"] as ConfigData;
	...
	private void OnConfigLoadFailure(BaseEvent e)
	{
		...
		ConfigLoader obj = sFSEvent.Target as ConfigLoader;
		obj.Dispatcher.RemoveEventListener(SFSEvent.CONFIG_LOAD_SUCCESS, OnConfigLoadSuccess);
		obj.Dispatcher.RemoveEventListener(SFSEvent.CONFIG_LOAD_FAILURE, OnConfigLoadFailure);
	...
	public void HandleHandShake(BaseEvent evt)
	{
		...
		{
			short num = iSFSObject.GetShort(BaseRequest.KEY_ERROR_CODE);
			Logger logger = log;
	...
	public void ProcessEvents()
	{
		...
		if (useWebSocket.HasValue && socketClient != null && socketClient.Socket is WebSocketLayer webSocketLayer)
		{
