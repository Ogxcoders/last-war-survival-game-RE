...
public class UnityEngineParticleSystemEmitParamsWrap
{
	public static void __Register(IntPtr L)
	{
		...
		Type typeFromHandle = typeof(ParticleSystem.EmitParams);
		Utils.BeginObjectRegister(typeFromHandle, L, translator, 0, 10, 14, 15);
		Utils.RegisterFunc(L, -3, "ResetPosition", _m_ResetPosition);
		Utils.RegisterFunc(L, -3, "ResetVelocity", _m_ResetVelocity);
		Utils.RegisterFunc(L, -3, "ResetAxisOfRotation", _m_ResetAxisOfRotation);
		Utils.RegisterFunc(L, -3, "ResetRotation", _m_ResetRotation);
		Utils.RegisterFunc(L, -3, "ResetAngularVelocity", _m_ResetAngularVelocity);
		Utils.RegisterFunc(L, -3, "ResetStartSize", _m_ResetStartSize);
		Utils.RegisterFunc(L, -3, "ResetStartColor", _m_ResetStartColor);
		Utils.RegisterFunc(L, -3, "ResetRandomSeed", _m_ResetRandomSeed);
		Utils.RegisterFunc(L, -3, "ResetStartLifetime", _m_ResetStartLifetime);
		Utils.RegisterFunc(L, -3, "ResetMeshIndex", _m_ResetMeshIndex);
		Utils.RegisterFunc(L, -2, "particle", _g_get_particle);
		Utils.RegisterFunc(L, -2, "position", _g_get_position);
		Utils.RegisterFunc(L, -2, "applyShapeToPosition", _g_get_applyShapeToPosition);
		...
		Utils.RegisterFunc(L, -1, "particle", _s_set_particle);
		Utils.RegisterFunc(L, -1, "position", _s_set_position);
		Utils.RegisterFunc(L, -1, "applyShapeToPosition", _s_set_applyShapeToPosition);
		...
		Utils.RegisterFunc(L, -1, "meshIndex", _s_set_meshIndex);
	...
	private static int __CreateInstance(IntPtr L)
	{
		try
		{
			...
			{
				objectTranslator.Push(L, default(ParticleSystem.EmitParams));
				return 1;
			}
		}
		catch (Exception ex)
		...
		return Lua.luaL_error(L, "invalid arguments to UnityEngine.ParticleSystem.EmitParams constructor!");
	}

	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _m_ResetPosition(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			objectTranslator.Get(L, 1, out ParticleSystem.EmitParams v);
			v.ResetPosition();
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _m_ResetVelocity(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _m_ResetAxisOfRotation(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			objectTranslator.Get(L, 1, out ParticleSystem.EmitParams v);
			v.ResetAxisOfRotation();
			objectTranslator.Update(L, 1, v);
			return 0;
		}
		catch (Exception ex)
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _m_ResetRotation(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _m_ResetAngularVelocity(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			objectTranslator.Get(L, 1, out ParticleSystem.EmitParams v);
			v.ResetAngularVelocity();
			objectTranslator.Update(L, 1, v);
			return 0;
		}
		catch (Exception ex)
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _m_ResetStartSize(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _m_ResetStartColor(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _m_ResetRandomSeed(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _m_ResetStartLifetime(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			objectTranslator.Get(L, 1, out ParticleSystem.EmitParams v);
			v.ResetStartLifetime();
			objectTranslator.Update(L, 1, v);
			return 0;
		}
		catch (Exception ex)
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _m_ResetMeshIndex(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _g_get_particle(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			objectTranslator.Get(L, 1, out ParticleSystem.EmitParams v);
			objectTranslator.Push(L, v.particle);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _g_get_applyShapeToPosition(IntPtr L)
	{
		try
		{
			ObjectTranslatorPool.Instance.Find(L).Get(L, 1, out ParticleSystem.EmitParams v);
			Lua.lua_pushboolean(L, v.applyShapeToPosition);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _s_set_particle(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			objectTranslator.Get(L, 1, out ParticleSystem.EmitParams v);
			objectTranslator.Get(L, 2, out ParticleSystem.Particle v2);
			v.particle = v2;
			objectTranslator.Update(L, 1, v);
		}
		catch (Exception ex)
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _s_set_applyShapeToPosition(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			objectTranslator.Get(L, 1, out ParticleSystem.EmitParams v);
			v.applyShapeToPosition = Lua.lua_toboolean(L, 2);
			objectTranslator.Update(L, 1, v);
		}
		catch (Exception ex)
		{
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _s_set_meshIndex(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			objectTranslator.Get(L, 1, out ParticleSystem.EmitParams v);
			v.meshIndex = Lua.xlua_tointeger(L, 2);
			objectTranslator.Update(L, 1, v);
		}
		catch (Exception ex)
		{
