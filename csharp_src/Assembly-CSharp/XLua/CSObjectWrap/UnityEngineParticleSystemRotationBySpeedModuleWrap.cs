...
public class UnityEngineParticleSystemRotationBySpeedModuleWrap
{
	public static void __Register(IntPtr L)
	{
		...
		Type typeFromHandle = typeof(ParticleSystem.RotationBySpeedModule);
	...
	private static int __CreateInstance(IntPtr L)
	{
		try
		{
			...
			{
				objectTranslator.Push(L, default(ParticleSystem.RotationBySpeedModule));
				return 1;
			}
		}
		catch (Exception ex)
		...
		return Lua.luaL_error(L, "invalid arguments to UnityEngine.ParticleSystem.RotationBySpeedModule constructor!");
	}
	...
	private static int _g_get_enabled(IntPtr L)
	{
		try
		{
			ObjectTranslatorPool.Instance.Find(L).Get(L, 1, out ParticleSystem.RotationBySpeedModule v);
	...
	private static int _g_get_x(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			objectTranslator.Get(L, 1, out ParticleSystem.RotationBySpeedModule v);
