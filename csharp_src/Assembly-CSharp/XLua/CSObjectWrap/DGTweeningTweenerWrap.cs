...
public class DGTweeningTweenerWrap
{
	public static void __Register(IntPtr L)
	{
		...
		Utils.BeginObjectRegister(typeFromHandle, L, translator, 0, 29, 0, 0);
	...
	private static int _m_ChangeStartValue(IntPtr L)
	{
		try
		{
			...
			if (num == 2 && objectTranslator.Assignable<object>(L, 2))
			{
				...
				Tweener o2 = tweener.ChangeStartValue(newStartValue2);
	...
	private static int _m_ChangeEndValue(IntPtr L)
	{
		try
		{
			...
			if (num == 4 && objectTranslator.Assignable<object>(L, 2) && LuaTypes.LUA_TNUMBER == Lua.lua_type(L, 3) && LuaTypes.LUA_TBOOLEAN == Lua.lua_type(L, 4))
			{
				...
				Tweener o2 = tweener.ChangeEndValue(newEndValue2, newDuration, snapStartValue2);
				objectTranslator.Push(L, o2);
				return 1;
			}
			if (num == 3 && objectTranslator.Assignable<object>(L, 2) && LuaTypes.LUA_TNUMBER == Lua.lua_type(L, 3))
			{
				...
				Tweener o3 = tweener.ChangeEndValue(newEndValue3, newDuration2);
			...
			if (num == 2 && objectTranslator.Assignable<object>(L, 2))
			{
				...
				Tweener o4 = tweener.ChangeEndValue(newEndValue4);
	...
	private static int _m_ChangeValues(IntPtr L)
	{
		try
		{
			...
			if (num == 3 && objectTranslator.Assignable<object>(L, 2) && objectTranslator.Assignable<object>(L, 3))
			{
				...
				Tweener o2 = tweener.ChangeValues(newStartValue2, newEndValue2);
				objectTranslator.Push(L, o2);
				return 1;
			}
		}
	...
	private static int _m_Pause(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			Tween o = ((Tweener)objectTranslator.FastGetCSObj(L, 1)).Pause();
			objectTranslator.Push(L, o);
			return 1;
		}
		catch (Exception ex)
	...
	private static int _m_Play(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			Tween o = ((Tweener)objectTranslator.FastGetCSObj(L, 1)).Play();
			objectTranslator.Push(L, o);
			return 1;
		}
		catch (Exception ex)
		...
		try
		{
			...
			case 2:
				if (LuaTypes.LUA_TBOOLEAN == Lua.lua_type(L, 2))
				{
					...
					Tween o = tweener.SetAutoKill(autoKillOnCompletion);
					objectTranslator.Push(L, o);
					return 1;
				}
				break;
	...
	private static int _m_SetRecyclable(IntPtr L)
	{
		try
		{
			...
			case 1:
			{
				Tween o2 = tweener.SetRecyclable();
				objectTranslator.Push(L, o2);
				return 1;
			}
			case 2:
				if (LuaTypes.LUA_TBOOLEAN == Lua.lua_type(L, 2))
				{
					...
					Tween o = tweener.SetRecyclable(recyclable);
					objectTranslator.Push(L, o);
					return 1;
				}
				break;
	...
	private static int _m_SetDelay(IntPtr L)
	{
		...
		return Lua.luaL_error(L, "invalid arguments to DG.Tweening.Tweener.SetDelay!");
	}
	...
	private static int _m_SetRelative(IntPtr L)
	{
		try
		{
			...
			case 2:
				...
				{
					bool isRelative = Lua.lua_toboolean(L, 2);
					Tween o = tweener.SetRelative(isRelative);
					objectTranslator.Push(L, o);
					return 1;
				}
				break;
	...
	private static int _m_SetSpeedBased(IntPtr L)
	{
		try
		{
			...
			case 1:
			{
				Tween o2 = tweener.SetSpeedBased();
				objectTranslator.Push(L, o2);
				return 1;
			}
			case 2:
				if (LuaTypes.LUA_TBOOLEAN == Lua.lua_type(L, 2))
				{
					...
					Tween o = tweener.SetSpeedBased(isSpeedBased);
					objectTranslator.Push(L, o);
					return 1;
				}
				break;
	...
	private static int _m_ScriptOnComplete(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			Tweener tween = (Tweener)objectTranslator.FastGetCSObj(L, 1);
			TweenCallback action = objectTranslator.GetDelegate<TweenCallback>(L, 2);
