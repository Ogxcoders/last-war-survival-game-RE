...
public class FibMatrixRenderingHotUpdatableCustomRenderObjectsFeatureHotUpdatableRenderTargetSettingsWrap
{
	public static void __Register(IntPtr L)
	{
		ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		Type typeFromHandle = typeof(CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings);
	...
	private static int __CreateInstance(IntPtr L)
	{
		try
		{
			...
			{
				CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings o = new CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings();
		...
		return Lua.luaL_error(L, "invalid arguments to FibMatrix.RenderingHotUpdatable.CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings constructor!");
	}
	...
	private static int _g_get_overrideTarget(IntPtr L)
	{
		try
		{
			CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings renderTargetSettings = (CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1);
	...
	private static int _g_get_size(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings renderTargetSettings = (CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings)objectTranslator.FastGetCSObj(L, 1);
	...
	private static int _s_set_overrideTarget(IntPtr L)
	{
		try
		{
			((CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).overrideTarget = Lua.lua_toboolean(L, 2);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_name(IntPtr L)
	{
		try
		{
			((CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).name = Lua.lua_tostring(L, 2);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_scale(IntPtr L)
	{
		try
		{
			((CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).scale = (float)Lua.lua_tonumber(L, 2);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_depth(IntPtr L)
	{
		try
		{
			((CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).depth = Lua.xlua_tointeger(L, 2);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
