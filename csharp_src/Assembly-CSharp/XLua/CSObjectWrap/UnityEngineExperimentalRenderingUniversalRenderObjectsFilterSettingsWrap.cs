...
public class UnityEngineExperimentalRenderingUniversalRenderObjectsFilterSettingsWrap
{
	public static void __Register(IntPtr L)
	{
		ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		Type typeFromHandle = typeof(RenderObjects.FilterSettings);
	...
	private static int __CreateInstance(IntPtr L)
	{
		try
		{
			...
			{
				RenderObjects.FilterSettings o = new RenderObjects.FilterSettings();
		...
		return Lua.luaL_error(L, "invalid arguments to UnityEngine.Experimental.Rendering.Universal.RenderObjects.FilterSettings constructor!");
	}
	...
	private static int _g_get_RenderQueueType(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			RenderObjects.FilterSettings filterSettings = (RenderObjects.FilterSettings)objectTranslator.FastGetCSObj(L, 1);
	...
	private static int _s_set_PassNames(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			((RenderObjects.FilterSettings)objectTranslator.FastGetCSObj(L, 1)).PassNames = (string[])objectTranslator.GetObject(L, 2, typeof(string[]));
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
