...
public class UnityEngineUIVerticalLayoutGroupWrap
{
	public static void __Register(IntPtr L)
	{
		...
		Type typeFromHandle = typeof(VerticalLayoutGroup);
	...
	{
		return Lua.luaL_error(L, "UnityEngine.UI.VerticalLayoutGroup does not have a constructor!");
	}
	...
	private static int _m_CalculateLayoutInputHorizontal(IntPtr L)
	{
		try
		{
			((VerticalLayoutGroup)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).CalculateLayoutInputHorizontal();
			return 0;
		}
		catch (Exception ex)
		{
	...
	private static int _m_CalculateLayoutInputVertical(IntPtr L)
	{
		try
		{
			((VerticalLayoutGroup)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).CalculateLayoutInputVertical();
			return 0;
		}
		catch (Exception ex)
		{
	...
	private static int _m_SetLayoutHorizontal(IntPtr L)
	{
		try
		{
			((VerticalLayoutGroup)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).SetLayoutHorizontal();
			return 0;
		}
		catch (Exception ex)
		{
	...
	private static int _m_SetLayoutVertical(IntPtr L)
	{
		try
		{
			((VerticalLayoutGroup)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).SetLayoutVertical();
			return 0;
		}
		catch (Exception ex)
		{
