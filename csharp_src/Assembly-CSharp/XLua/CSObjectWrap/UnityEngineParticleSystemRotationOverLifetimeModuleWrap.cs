...
public class UnityEngineParticleSystemRotationOverLifetimeModuleWrap
{
	public static void __Register(IntPtr L)
	{
		...
		Type typeFromHandle = typeof(ParticleSystem.RotationOverLifetimeModule);
	...
	private static int __CreateInstance(IntPtr L)
	{
		try
		{
			...
			{
				objectTranslator.Push(L, default(ParticleSystem.RotationOverLifetimeModule));
				return 1;
			}
		}
		catch (Exception ex)
		...
		return Lua.luaL_error(L, "invalid arguments to UnityEngine.ParticleSystem.RotationOverLifetimeModule constructor!");
	}
	...
	private static int _g_get_enabled(IntPtr L)
	{
		try
		{
			ObjectTranslatorPool.Instance.Find(L).Get(L, 1, out ParticleSystem.RotationOverLifetimeModule v);
	...
	private static int _g_get_x(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			objectTranslator.Get(L, 1, out ParticleSystem.RotationOverLifetimeModule v);
