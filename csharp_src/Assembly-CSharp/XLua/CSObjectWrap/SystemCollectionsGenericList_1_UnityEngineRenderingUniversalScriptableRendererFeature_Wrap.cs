...
public class SystemCollectionsGenericList_1_UnityEngineRenderingUniversalScriptableRendererFeature_Wrap
{
	...
	private static int _m_Exists(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			List<ScriptableRendererFeature> list = (List<ScriptableRendererFeature>)objectTranslator.FastGetCSObj(L, 1);
			Predicate<ScriptableRendererFeature> match = objectTranslator.GetDelegate<Predicate<ScriptableRendererFeature>>(L, 2);
	...
	private static int _m_Find(IntPtr L)
	{
		try
		{
			...
			List<ScriptableRendererFeature> list = (List<ScriptableRendererFeature>)objectTranslator.FastGetCSObj(L, 1);
			Predicate<ScriptableRendererFeature> match = objectTranslator.GetDelegate<Predicate<ScriptableRendererFeature>>(L, 2);
			ScriptableRendererFeature o = list.Find(match);
			objectTranslator.Push(L, o);
			return 1;
		}
		catch (Exception ex)
	...
	private static int _m_FindAll(IntPtr L)
	{
		try
		{
			...
			List<ScriptableRendererFeature> list = (List<ScriptableRendererFeature>)objectTranslator.FastGetCSObj(L, 1);
			Predicate<ScriptableRendererFeature> match = objectTranslator.GetDelegate<Predicate<ScriptableRendererFeature>>(L, 2);
			List<ScriptableRendererFeature> o = list.FindAll(match);
			objectTranslator.Push(L, o);
			return 1;
		}
		catch (Exception ex)
	...
	private static int _m_FindIndex(IntPtr L)
	{
		try
		{
			...
			if (num == 3 && LuaTypes.LUA_TNUMBER == Lua.lua_type(L, 2) && objectTranslator.Assignable<Predicate<ScriptableRendererFeature>>(L, 3))
			{
				...
				Predicate<ScriptableRendererFeature> match2 = objectTranslator.GetDelegate<Predicate<ScriptableRendererFeature>>(L, 3);
			...
			if (num == 4 && LuaTypes.LUA_TNUMBER == Lua.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == Lua.lua_type(L, 3) && objectTranslator.Assignable<Predicate<ScriptableRendererFeature>>(L, 4))
			{
				...
				int count = Lua.xlua_tointeger(L, 3);
				Predicate<ScriptableRendererFeature> match3 = objectTranslator.GetDelegate<Predicate<ScriptableRendererFeature>>(L, 4);
	...
	private static int _m_FindLast(IntPtr L)
	{
		try
		{
			...
			List<ScriptableRendererFeature> list = (List<ScriptableRendererFeature>)objectTranslator.FastGetCSObj(L, 1);
			Predicate<ScriptableRendererFeature> match = objectTranslator.GetDelegate<Predicate<ScriptableRendererFeature>>(L, 2);
			ScriptableRendererFeature o = list.FindLast(match);
			objectTranslator.Push(L, o);
			return 1;
		}
		catch (Exception ex)
	...
	private static int _m_ForEach(IntPtr L)
	{
		try
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			List<ScriptableRendererFeature> list = (List<ScriptableRendererFeature>)objectTranslator.FastGetCSObj(L, 1);
			Action<ScriptableRendererFeature> action = objectTranslator.GetDelegate<Action<ScriptableRendererFeature>>(L, 2);
			list.ForEach(action);
			return 0;
		}
		catch (Exception ex)
	...
	private static int _m_Sort(IntPtr L)
	{
		try
		{
			...
			{
				Comparison<ScriptableRendererFeature> comparison = objectTranslator.GetDelegate<Comparison<ScriptableRendererFeature>>(L, 2);
