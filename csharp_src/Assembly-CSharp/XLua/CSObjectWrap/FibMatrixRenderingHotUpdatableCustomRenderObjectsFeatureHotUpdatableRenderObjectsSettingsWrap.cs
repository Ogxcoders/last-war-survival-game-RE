...
public class FibMatrixRenderingHotUpdatableCustomRenderObjectsFeatureHotUpdatableRenderObjectsSettingsWrap
{
	public static void __Register(IntPtr L)
	{
		ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		Type typeFromHandle = typeof(CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings);
		...
		Utils.RegisterFunc(L, -2, "overrideGlobalProperties", _g_get_overrideGlobalProperties);
		...
		Utils.RegisterFunc(L, -1, "overrideGlobalProperties", _s_set_overrideGlobalProperties);
	...
	private static int __CreateInstance(IntPtr L)
	{
		try
		{
			...
			{
				CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings o = new CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings();
		...
		return Lua.luaL_error(L, "invalid arguments to FibMatrix.RenderingHotUpdatable.CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings constructor!");
	}
	...
	private static int _g_get_passTag(IntPtr L)
	{
		try
		{
			CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings renderObjectsSettings = (CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1);
	...
	private static int _g_get_cameraType(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings renderObjectsSettings = (CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)objectTranslator.FastGetCSObj(L, 1);
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _g_get_overrideGlobalProperties(IntPtr L)
	{
		try
		{
			CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings renderObjectsSettings = (CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1);
			Lua.lua_pushboolean(L, renderObjectsSettings.overrideGlobalProperties);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_passTag(IntPtr L)
	{
		try
		{
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).passTag = Lua.lua_tostring(L, 2);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_eventOffset(IntPtr L)
	{
		try
		{
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).eventOffset = Lua.xlua_touint(L, 2);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_filterSettings(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)objectTranslator.FastGetCSObj(L, 1)).filterSettings = (CustomRenderObjectsFeatureHotUpdatable.FilterSettings)objectTranslator.GetObject(L, 2, typeof(CustomRenderObjectsFeatureHotUpdatable.FilterSettings));
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_overrideMaterial(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)objectTranslator.FastGetCSObj(L, 1)).overrideMaterial = (Material)objectTranslator.GetObject(L, 2, typeof(Material));
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	[MonoPInvokeCallback(typeof(lua_CSFunction))]
	private static int _s_set_overrideGlobalProperties(IntPtr L)
	{
		try
		{
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).overrideGlobalProperties = Lua.lua_toboolean(L, 2);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_overrideMaterialPassIndex(IntPtr L)
	{
		try
		{
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).overrideMaterialPassIndex = Lua.xlua_tointeger(L, 2);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_overrideDepthState(IntPtr L)
	{
		try
		{
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).overrideDepthState = Lua.lua_toboolean(L, 2);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_enableWrite(IntPtr L)
	{
		try
		{
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)ObjectTranslatorPool.Instance.Find(L).FastGetCSObj(L, 1)).enableWrite = Lua.lua_toboolean(L, 2);
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_stencilSettings(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)objectTranslator.FastGetCSObj(L, 1)).stencilSettings = (StencilStateData)objectTranslator.GetObject(L, 2, typeof(StencilStateData));
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_cameraSettings(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)objectTranslator.FastGetCSObj(L, 1)).cameraSettings = (RenderObjects.CustomCameraSettings)objectTranslator.GetObject(L, 2, typeof(RenderObjects.CustomCameraSettings));
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
	...
	private static int _s_set_renderTargetSettings(IntPtr L)
	{
		...
		{
			ObjectTranslator objectTranslator = ObjectTranslatorPool.Instance.Find(L);
			((CustomRenderObjectsFeatureHotUpdatable.RenderObjectsSettings)objectTranslator.FastGetCSObj(L, 1)).renderTargetSettings = (CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings)objectTranslator.GetObject(L, 2, typeof(CustomRenderObjectsFeatureHotUpdatable.RenderTargetSettings));
		}
		catch (Exception ex)
		{
			return Lua.luaL_error(L, "c# exception:" + ex);
