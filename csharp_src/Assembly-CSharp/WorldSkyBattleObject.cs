...
public class WorldSkyBattleObject : WorldDetectEventItemObject
{
	public WorldSkyBattleObject(WorldScene worldScene, int pointIndex, int pType)
	...
	protected override string GetModePath()
	{
		...
		return $"Assets/Main/Prefabs/CollectResource/{text}.prefab";
	}
}
