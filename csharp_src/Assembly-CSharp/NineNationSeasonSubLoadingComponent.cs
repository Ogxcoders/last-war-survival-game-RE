...
public class NineNationSeasonSubLoadingComponent : BaseSubLoadingComponent
{
	public override void SetBg()
	{
		string imagePath = "Assets/Main/SingleSprites/lrb_S5_loading_banner.png";
		SetImage(imagePath, background);
	}

	public override void SetIcon()
	{
		string text = "Assets/Main/Loading/Season/cfm_logo_S5.png";
		...
		{
			text = "Assets/Main/Loading/Season/cfm_logo_S5.png";
		}
