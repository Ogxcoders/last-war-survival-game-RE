...
public class DetectEventLastStandObject : WorldPointObject
{
	public string eventId;

	private SimpleAnimation _animation;

	public DetectEventLastStandObject(WorldScene worldScene, int pointIndex, int pType)
	...
	public virtual void AsyncCompleteCallBack(InstanceRequest instance)
	{
		...
		if (gameObject != null)
		{
			gameObject.name = "DetectEventLastStand_" + pointIndex;
