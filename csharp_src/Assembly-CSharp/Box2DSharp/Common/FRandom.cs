...
public class FRandom
{
	...
	public static FVector3 insideUnitSphere => new FVector3(value, value, value);
	...
	public FP NextFP(FP minValue, FP maxValue)
	{
		...
		return FP.Floor((maxValue - minValue + (FP)1) * NextFP() + minValue);
	}
	...
	public FP Next(float minValue, float maxValue)
	{
		...
		return FP.Floor((FP)(num2 - num + 1) * NextFP() + (FP)num) / 1000;
	}
	...
	{
		return (FP)genrand_int32() * (FP.One / 4294967295L);
	}
