...
public class CityWeatherRenderer : ScriptableRendererFeature
{
	private class CityWeatherRendererPass : ScriptableRenderPass
	{
		...
		public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
		{
			...
			Color mNightColor = CityWeatherRenderer.mNightColor;
	...
	private class CityWeatherColorClearPass : ScriptableRenderPass
	{
		public void Release()
		{
		}
	...
	private CityWeatherRendererPass m_NightColorPass;

	private CityWeatherColorClearPass m_NightClearPass;

	public override void Create()
	{
		m_NightColorPass = new CityWeatherRendererPass();
		m_NightClearPass = new CityWeatherColorClearPass();
	...
	public void DetachFromRenderer(Camera camera)
	{
		...
		Shader.SetGlobalColor(mEvColorId, Color.white);
