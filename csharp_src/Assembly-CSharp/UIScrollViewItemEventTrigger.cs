...
public class UIScrollViewItemEventTrigger : MonoBehaviour, IBeginDragHandler, IEventSystemHandler, IDragHandler, IDropHandler, IEndDragHandler, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
{
	...
	private void OnTransformParentChanged()
	{
		if (autoFindScrollRect)
		{
			...
			{
				scrollRect = GetComponentInParent<ScrollView>();
			}
