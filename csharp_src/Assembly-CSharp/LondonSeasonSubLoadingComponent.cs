...
public class LondonSeasonSubLoadingComponent : BaseSubLoadingComponent
{
	public override void SetBg()
	{
		string imagePath = "Assets/Main/SingleSprites/cfm_loading_S1.png";
		SetImage(imagePath, background);
	}

	public override void SetIcon()
	{
		string text = "Assets/Main/Loading/Season/cfm_saiji_logo_1.png";
		...
		{
			text = "Assets/Main/Loading/Season/cfm_saiji_logo_1.png";
		}
