...
public sealed class ScoutAllianceBuild : IMessage<ScoutAllianceBuild>, IMessage, IEquatable<ScoutAllianceBuild>, IDeepCloneable<ScoutAllianceBuild>
{
	private static readonly MessageParser<ScoutAllianceBuild> _parser = new MessageParser<ScoutAllianceBuild>(() => new ScoutAllianceBuild());
	...
	[DebuggerNonUserCode]
	public static MessageParser<ScoutAllianceBuild> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => LwScoutReportReflection.Descriptor.MessageTypes[24];
	...
	[DebuggerNonUserCode]
	public ScoutAllianceBuild()
	{
	}

	[DebuggerNonUserCode]
	public ScoutAllianceBuild(ScoutAllianceBuild other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	public ScoutAllianceBuild Clone()
	{
		return new ScoutAllianceBuild(this);
	}

	[DebuggerNonUserCode]
	public override bool Equals(object other)
	{
		return Equals(other as ScoutAllianceBuild);
	}

	[DebuggerNonUserCode]
	public bool Equals(ScoutAllianceBuild other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	public void MergeFrom(ScoutAllianceBuild other)
	{
		if (other == null)
		{
			return;
