...
public class UILoopListItemEventTrigger : MonoBehaviour, IBeginDragHandler, IEventSystemHandler, IDragHandler, IDropHandler, IEndDragHandler, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
{
	...
	private void OnTransformParentChanged()
	{
		...
		{
			if (base.transform.parent != null && loopListView == null)
			{
				loopListView = GetComponentInParent<LoopListView2>();
