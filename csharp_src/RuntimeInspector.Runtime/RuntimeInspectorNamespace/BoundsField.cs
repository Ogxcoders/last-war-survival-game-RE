...
public class BoundsField : InspectorField
{
	...
	protected override void OnBound(MemberInfo variable)
	{
		...
		if (base.BoundVariableType == typeof(BoundsInt))
		{
	...
	protected override void OnInspectorChanged()
	{
		...
		inputCenter.Inspector = base.Inspector;
		inputExtents.Inspector = base.Inspector;
	}

	protected override void OnSkinChanged()
	{
		base.OnSkinChanged();
		inputCenter.Skin = base.Skin;
		inputExtents.Skin = base.Skin;
	}

	protected override void OnDepthChanged()
	{
		base.OnDepthChanged();
		inputCenter.Depth = base.Depth + 1;
		inputExtents.Depth = base.Depth + 1;
	}
