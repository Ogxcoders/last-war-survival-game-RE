...
public static class ApiReflection
{
	...
	static ApiReflection()
	{
		...
		{
			new GeneratedClrTypeInfo(typeof(Api), Api.Parser, new string[7] { "Name", "Methods", "Options", "Version", "SourceContext", "Mixins", "Syntax" }, null, null, null, null),
			new GeneratedClrTypeInfo(typeof(Method), Method.Parser, new string[7] { "Name", "RequestTypeUrl", "RequestStreaming", "ResponseTypeUrl", "ResponseStreaming", "Options", "Syntax" }, null, null, null, null),
			new GeneratedClrTypeInfo(typeof(Mixin), Mixin.Parser, new string[2] { "Name", "Root" }, null, null, null, null)
		}));
	}
}
